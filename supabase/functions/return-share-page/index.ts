...
function returnSharePage(title: string, message: string) {
  ...
  <div class="mockup-browser border bg-base-300">
     ...
     <div class="flex justify-center px-4 py-16 bg-base-200">This personalized news has been generated by ActualIA, your daily companion for updates that matters to you.</div>
  </div>
  </html>
  `;
}
